...
namespace YG
{
    public class LanguageYG : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            else if (TMPTextComponent)
                baseFontSize = TMPTextComponent.fontSize;
        }
        ...
        void AssignTranslate(string translation)
        {
            if (textUIComponent)
                ...
                TMPTextComponent.text = translation;
        }
        ...
        {
            if (textUIComponent)
                textUIComponent.fontSize = (int)baseFontSize;
            else if (textMeshComponent)
                textMeshComponent.fontSize = (int)baseFontSize;
            else if (TMPTextComponent)
                TMPTextComponent.fontSize = baseFontSize;
            ...
            if (fontSizeArray.Length != 0 && fontSizeArray.Length >= fontNumber - 1)
            {
                if (textUIComponent)
                    ...
                    TMPTextComponent.fontSize += fontSizeArray[fontNumber];
            }
        }
