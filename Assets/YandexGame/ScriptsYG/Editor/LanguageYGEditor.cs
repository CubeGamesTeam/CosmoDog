...
namespace YG
{
    ...
    public class LanguageYGEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (scr.textUIComponent == null && scr.textMeshComponent == null && scr.TMPTextComponent == null)
            {
                if (GUILayout.Button("Identify Text/TextMesh(Pro)"))
                {
                    scr.textUIComponent = scr.GetComponent<Text>();
                    scr.textMeshComponent = scr.GetComponent<TextMesh>();
                    scr.TMPTextComponent = scr.GetComponent<TMP_Text>();
                }
                ...
                if (GUILayout.Button("Create TextMeshPro - Text компонент"))
                    scr.TMPTextComponent = scr.gameObject.AddComponent<TMP_Text>();
            ...
            if (scr.infoYG)
            {
                if (scr.infoYG.translateMethod == InfoYG.TranslateMethod.CSVFile)
                {
                    ...
                    scr.componentTextField = EditorGUILayout.ToggleLeft("Component Text/TextMesh/TextMeshPro Translate", scr.componentTextField);
                    ...
                    if (scr.componentTextField)
                    {
                        ...
                        else if (scr.TMPTextComponent)
                        {
                            GUILayout.Label(scr.TMPTextComponent.text);

                            if (scr.TMPTextComponent == null || scr.TMPTextComponent.text.Length == 0)
                                availableStr = false;
                        }
                    }
                    else
                ...
                else
                {
                    ...
                    if (scr.infoYG.translateMethod == InfoYG.TranslateMethod.AutoLocalization)
                    {
                        ...
                        else
                        {
                            ...
                            else if (scr.TMPTextComponent) GUILayout.Label(scr.TMPTextComponent.text);
                        }
                        ...
                        if (scr.componentTextField)
                        {
                            ...
                            {
                                if (scr.TMPTextComponent.text.Length > 0)
                                {
                                    GUILayout.Label("TextMeshPro - Text Component", green);

                                    if (GUILayout.Button("TRANSLATE"))
                                        TranslateButton();
                                }
                                else
                                    GUILayout.Label("TextMeshPro - Text Component", red);
                            }
                        }
                        else
                        {
            ...
            if (scr.textUIComponent || scr.textMeshComponent || scr.TMPTextComponent)
            {
                GUILayout.Space(10);
                GUILayout.BeginVertical("box");
                ...
                if (GUILayout.Button("Replace the font with the standard one"))
                {
                    if (scr.infoYG.fonts.defaultFont.Length >= scr.fontNumber + 1 && scr.infoYG.fonts.defaultFont[scr.fontNumber])
                    {
                      ...
                      /*  else if (scr.TMPTextComponent)
                            scr.TMPTextComponent.font = scr.infoYG.fonts.defaultFont[scr.fontNumber];*/
                    }
                    else
                    {
        ...
        void TranslateButton()
        {
            ...
            if (!scr.componentTextField)
            {
                ...
                if (scr.TMPTextComponent)
                    scr.TMPTextComponent.text = scr.text;
            }
        }
